...
import {getAllActiveGames, getGameBySlug, getScoresByDifficulty, setUserScore, findUserScore, getUserXP, setUserBalance } from '../controllers/games.controller.js';
...
router.get("/user/balance", protectRoute, getUserXP)

router.post("/games/score", protectRoute, setUserBalance)
