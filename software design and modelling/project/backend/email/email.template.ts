...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #2196F3, #1976D2); padding: 20px; text-align: center; border-radius: 5px 5px 0 0;">
    <h1 style="color: #fff; margin: 0;">Password Updated Successfully</h1>
  </div>
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hello,</p>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #4CAF50, #45a049); padding: 20px; text-align: center;"> 
    <h1 style="color: white; margin: 0;">Welcome to Academy!</h1>
  </div>
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    <p>Hi,</p>
    <p>I’m thrilled to have you here! Thank you for signing up for Academy.</p>
    <p>Here are a few tips to help you get started:</p>
    <ul>
      <li>Explore the exercises and start learning.</li>
      <li>Track your progress and earn XP.</li>
      <li>Challenge yourself with games and practice problems.</li>
    </ul>
    <p>I want you to have the best possible experience. If you ever need help, have questions, or want to suggest improvements, I’m always here to assist you.</p>
