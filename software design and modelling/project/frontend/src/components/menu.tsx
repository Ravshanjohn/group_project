        ...
        >
            ...
            <div className="flex-none px-3 py-6 flex items-center">
                <div className="flex items-center">
                    {!isExpanded ? (
                        <span className="flex h-8 w-8 items-center justify-center rounded-md bg-white text-sm font-black text-black shadow-sm">
                            A
                        </span>
                    ) : (
                        <div className="flex items-center">
                            ...
                            <span className="ml-3 font-bold text-xl text-white tracking-wide whitespace-nowrap overflow-hidden transition-all duration-300">
                                cademy
                            </span>
                        </div>
                    )}
