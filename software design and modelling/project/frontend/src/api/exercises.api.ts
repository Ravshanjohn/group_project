...
export const exercises_api: exercisesApi = {
  ...
  getExerciseBySlug: async (slug) => {
    ...
    try {
      ...
      if (res.data.error) throw new Error(res.data.error.message || "Exercise not found or inaccessible");
  ...
  getAllExercises: async () => {
    ...
    try {
      ...
      if (res.data.error) throw new Error(res.data.error.message || "Failed to fetch exercises");
      return res.data.data ?? [];
    } catch (error) {
      toast.error(getErrorMessage(error));
      throw error;
  ...
  getInitialCode: async (slug, language_id) => {
    ...
    try {
      ...
      if (res.data.error) throw new Error(res.data.error.message || "Failed to fetch initial code");
      return res.data.data;
    } catch (error) {
      toast.error(getErrorMessage(error));
      throw error;
  ...
  getTestCase: async (slug) => {
    ...
    try {
      ...
      if (res.data.error) throw new Error(res.data.error.message || "Failed to fetch exercise test case");
      return res.data.data;
    } catch (error) {
      toast.error(getErrorMessage(error));
      throw error;
  ...
  getExerciseSignature: async (slug) => {
    ...
    try {
      ...
      if (res.data.error) throw new Error(res.data.error.message || "Failed to fetch exercise signature");
      return res.data.data;
    } catch (error) {
      toast.error(getErrorMessage(error));
      throw error;
  ...
  getExerciseLanguages: async (slug) => {
    ...
    try {
      ...
      if (res.data.error) throw new Error(res.data.error.message || "Failed to fetch exercise languages");
      return res.data.data ?? [];
    } catch (error) {
      toast.error(getErrorMessage(error));
      throw error;
  ...
  getMaps: async () => {
    try {
      const res = await instance.get('/maps');
      if (res.data.error) throw new Error(res.data.error.message || "Failed to fetch maps");
      return res.data.data ?? [];
    } catch (error) {
  ...
  handleExerciseEvent: async (slug, language_id, reason, code) => {
    ...
    try {
      ...
      if (res.data.error) throw new Error(res.data.error.message || "Failed to record exercise event");
    } catch (error) {
      toast.error(getErrorMessage(error));
      throw error;
    } finally {
